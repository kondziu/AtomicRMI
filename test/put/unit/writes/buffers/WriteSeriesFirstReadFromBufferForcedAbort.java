...
/**
 * Read from buffer after a series of buffered writes, forced abort test case.
 * 
 * <pre>
 * T1 [ r(x)0       w(x)1 						!
 * T2  [      w(x)2        w(x)3 r(x)3 r(x)3 -----! #forced
 * </pre>
 * 
 ...
 */
public class WriteSeriesFirstReadFromBufferForcedAbort extends RMITest {
	...
	@Test
	public void writeSeriesFirstReadFromBufferForcedAbort() throws Throwable {

...
/**
 * 
 * Write after read (after first write) then abort test case.
 * 
 * <pre>
 * T1 [ r(x)0       w(x)1  					   ]
 * T2  [      w(x)2        r(x)2 w(x)3  r(x)3   !
 * </pre>
 * 
 ...
 */
public class WriteAfterReadThenAbort extends RMITest {
	...
	@Test
	public void writeAfterReadThenAbort() throws Throwable {

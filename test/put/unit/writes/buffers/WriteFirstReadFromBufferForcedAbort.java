...
/**
 * Read from buffer after buffered write, attempt commit and fail test case.
 * 
 * <pre>
 * T1 [ r(x)0       w(x)1                !
 * T2  [      w(x)2        r(x)2  r(x)2 ---! #forced
 * </pre>
 * 
 ...
 */
public class WriteFirstReadFromBufferForcedAbort extends RMITest {

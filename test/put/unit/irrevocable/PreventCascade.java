 ...
 * 
 * <pre>
 * T1 [   r(x)0 w(x)1              r(y)0 w(y)1 r(z)0 w(z)1              !
 * T2   [             r(x)----------------------------------------------1 w(x)1              r(y)0 w(y)1 r(z)0 w(z)1    !
 * </pre>
 */
public class PreventCascade extends RMITest {
	class Threads extends MultithreadedTest {
		...
		public void thread2() {
			...
			try {
				int v;
				t = new Transaction(Type.Irrevocable);
				Variable x = t.accesses((Variable) registry.lookup("x"), 2);
				Variable y = t.accesses((Variable) registry.lookup("y"), 2);
				Variable z = t.accesses((Variable) registry.lookup("z"), 2);
				...
				Assert.fail("Transaction aborted when it should have committed.");
			} catch (Exception e) {
				e.printStackTrace();
				throw new RuntimeException(e.getMessage(), e.getCause());
			}
	...
	@Test
	public void preventCascade() throws Throwable {
